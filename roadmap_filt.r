...
# CMD usage: Rscript roadmap_filt.r
...
path = paste0(dir,'E',cid,'_25_imputed12marks_hg38lift_dense.bed.rds')
...
close(pb)
cat(paste0('\n>> RDS file read, ',pdtime(t0,2),'\n'))
road.df = ldply(road.li, data.frame) #plyr

# 2. Filtering by enhancers and save as BED file
cat("\n(2/2) Filtering RoadMap data by enhancers\n")
